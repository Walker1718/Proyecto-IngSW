...
<div id="sidebar-container" class="bg-primary  ">
            <div class="logo">
                <img src="https://cdn.discordapp.com/attachments/389571579828502538/834237334815637533/AdminLTELogo.png" alt="logo" width="50" height="50">
                <h4 class="text-light font-weight-bold mb-0">Aperture</h4>
            </div>
            ...
            <div class="menu">
                ...
                <a href="../" class="d-block text-light p-3 border-0"><i class="fas fa-file-signature"></i>
                Craer Contrato</a>

                <a href="../" class="d-block text-light p-3 border-0"><i class="fas fa-file-contract"></i>
                Contratos</a>

                <a href="../" class="d-block text-light p-3 border-0"><i class="fas fa-chart-line"></i>
                Estadísticas</a>

                <a href="../perfil/" class="d-block text-light p-3 border-0"><i class="fas fa-user-circle"></i>
                Perfil</a>
